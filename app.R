    ...
    dashboardBody(
         tabItems(
            ...
            tabItem(tabName = "rfimp",
                  h2("Random Forest"),
                    fluidRow(
                        box(dataTableOutput("dt1"), title = "Random Forest Cross Validation Results"),
                        box(plotOutput("rfvarimportance", width = "100%"))
                        ),
                    fluidRow(
                        box(verbatimTextOutput("confusion"), title = "Confusion Matrix"),
